...
`python scripts/cycle_orders.py open-cycle $ORDER_MODE ...`, which validates
the research report artifact, runs the policy gate, plans both orders, and
exercises rollback behavior.
